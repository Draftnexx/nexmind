...
export function classifyNote(content: string): NoteCategory {
  ...
  // Aufgaben-Keywords
  const taskKeywords = [
    "todo", "erledigen", "aufgabe", "machen", "fertig", "erledigt",
    "task", "checklist", "must", "sollte", "muss", "muss ich"
  ];
  ...
  const personKeywords = [
    "person", "kontakt", "telefon", "email", "anrufen", "telefonieren",
    "sprechen mit", "nachricht an", "@", "herr", "frau", "kollege",
    "kollegin", "chef", "call", "mit ", "treffen mit"
  ];
